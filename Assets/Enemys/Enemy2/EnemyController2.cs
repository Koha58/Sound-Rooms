...
public class EnemyController2 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EnemyGetRandomPosition2 EGRP2 = EnemyGetRandomPosition.GetComponent<EnemyGetRandomPosition2>();
        // 初期位置をランダムに設定する
        targetPosition = EGRP2.GetRandomPosition();
    ...
    private void Update()
    {
        ...
        if (EC.Chase == true)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            ...
            EnemysSeen2 EsS = EnemysSeen2.GetComponent<EnemysSeen2>();
