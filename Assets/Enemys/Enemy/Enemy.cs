...
public class Enemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        */
        ...
        if (detectionPlayer <= EnemyChase.Detection && ES.ONoff == 1&& EnemyCube.Enemybefor == false)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            if (PS.onoff == 0)
            {
        ...
        else if (detectionPlayer >= EnemyChase.Detection || PS.onoff == 0 ||EnemyCube. Enemybefor == true)//Playerが検知範囲に入っていないまたはPlayerが見えていない
        {
