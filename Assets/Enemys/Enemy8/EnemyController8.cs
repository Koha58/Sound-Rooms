...
public class EnemyController8 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EnemyGetRandomPosition8 EGRP8 = EnemyGetRandomPosition.GetComponent<EnemyGetRandomPosition8>();
        // 初期位置をランダムに設定する
        targetPosition = EGRP8.GetRandomPosition();
    ...
    private void Update()
    {
        ...
        if (EC.Chase== true)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            ...
            EnemysSeen8 EsS = EnemysSeen8.GetComponent<EnemysSeen8>();
