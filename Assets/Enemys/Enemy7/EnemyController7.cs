...
public class EnemyController7 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EnemyGetRandomPosition7 EGRP7 = EnemyGetRandomPosition.GetComponent<EnemyGetRandomPosition7>();
        // 初期位置をランダムに設定する
        targetPosition = EGRP7.GetRandomPosition();
    ...
    private void Update()
    {
        ...
        if (EC.Chase == true)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            ...
            EnemysSeen7 EsS = EnemysSeen7.GetComponent<EnemysSeen7>();
