...
public class EnemyController9 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        EnemyGetRandomPosition9 EGRP9 = EnemyGetRandomPosition.GetComponent<EnemyGetRandomPosition9>();
        // 初期位置をランダムに設定する
        targetPosition = EGRP9.GetRandomPosition();
    ...
    private void Update()
    {
        ...
        if (EC.Chase == true)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            ...
            EnemysSeen9 EsS = EnemysSeen9.GetComponent<EnemysSeen9>();
