...
public class EnemyController10 : MonoBehaviour
{
    ...
    public GameObject EnemysSeen10;
    ...
    private void Start()
    {
        ...
        EnemyGetRandomPosition10 EGRP10 = EnemyGetRandomPosition.GetComponent<EnemyGetRandomPosition10>();
        // 初期位置をランダムに設定する
        targetPosition = EGRP10.GetRandomPosition();
    ...
    private void Update()
    {
        ...
        if (EC.Chase == true)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            ...
            EnemysSeen10 EsS = EnemysSeen10.GetComponent<EnemysSeen10>();
