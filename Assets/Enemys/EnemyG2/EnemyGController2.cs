...
public class EnemyGController2 : MonoBehaviour
{
    ...
    public GameObject EnemysSeenG2;
    ...
    private void Start()
    {
        ...
        EnemyGGetRandomPosition2 EGRP2 = EnemyGGetRandomPosition.GetComponent<EnemyGGetRandomPosition2>();
        // 初期位置をランダムに設定する
        targetPosition = EGRP2.GetRandomPositionG();
    ...
    private void Update()
    {
        ...
        if (EGC.GChase == true)//Enemyが可視化状態かつプレイヤーが検知範囲に入ったら
        {
            ...
            EnemysGSeen2 EsS = EnemysSeenG2.GetComponent<EnemysGSeen2>();
